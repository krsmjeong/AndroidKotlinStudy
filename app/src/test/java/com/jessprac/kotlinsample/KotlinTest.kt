...
//
//        // 코틀린은 age를 직접 사용해도 자동으로 setter가 불린다.
//        person.age = 20
//
//        // 설정한 값이 정상적인지 테스트
//        // 마찬가지로 직접 프로퍼티에 접근해도 자동으로 getter가 불린다.
...
//        val fruit1 = FruitKotlin("바나나", "바나나 맛나")
//        val fruit2 = FruitKotlin("바나나", "바나나 맛나")
//
//        // 각각 프린트 한다. toString() 메소드가 호출된다.
//        println(fruit1)
//        println(fruit2)
//
...
//    }
    ...
    @Test
    fun testCollectionnApi(){
        // 컬렉션을 만든다.
        val list = listOf(1, "2", 3, 4, 5.7, 1, 2)

        // filter: 컬렉션ㅇ서 특정 조건이 맞는 항목만 추춣여 새로운 컬렉션을 만든다.-> Int타입만 추출한다.
